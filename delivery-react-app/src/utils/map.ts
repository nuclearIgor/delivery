...
export class GoogleMap {
    ...
    addRoute(
        ...
        // this.routes[id] = new Route(routeOptions)
        ...
        this.routes[id] = new Route({
            currentMarkerOptions: {...routeOptions.currentMarkerOptions, map: this.map},
            endMarkerOptions: {...routeOptions.endMarkerOptions, map: this.map}
        })
